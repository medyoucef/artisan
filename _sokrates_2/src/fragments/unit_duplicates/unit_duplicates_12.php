vendor/larastan/larastan/src/Methods/EloquentBuilderForwardsCallsExtension.php [67:159]:
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
vendor/nunomaduro/larastan/src/Methods/EloquentBuilderForwardsCallsExtension.php [67:159]:
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    private function findMethod(ClassReflection $classReflection, string $methodName): MethodReflection|null
    {
        if (! $classReflection->is(EloquentBuilder::class)) {
