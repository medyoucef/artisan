...
<div class="row" id="artisan-results">
    <?php $__currentLoopData = $artisans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artisan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-6">
            <div class="team-item">
                <div class="team-img">
                    <img src="<?php echo e(asset('img/' . $artisan->photo)); ?>" alt="Photo Artisan" style="width:100%; height:250px; object-fit:cover;">
                </div>
                <div class="team-text">
...
<?php /**PATH C:\Users\INFOBOX\Desktop\chercher_art\resources\views/front/art_ind.blade.php ENDPATH**/ ?>