    ...
    <?php $__currentLoopData = $societes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $societe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-3 col-md-6">
            <div class="team-item">
                <div class="team-img">
                    <img 
                        src="<?php echo e(Str::startsWith($societe->photo, 'photos/') ? asset('storage/' . $societe->photo) : asset('img/' . $societe->photo)); ?>" 
                        alt="Photo Société" 
                        style="width:100%; height:250px; object-fit:cover;">
                </div>
                    <div class="team-text">
                        <h2><?php echo e($societe->name); ?></h2>
                        <p><i class="fas fa-map-marker-alt"></i>  <?php echo e($societe->adresse); ?></p>
...
<?php /**PATH C:\xampp\htdocs\chercher_art\resources\views/front/art_soc.blade.php ENDPATH**/ ?>